...
Page({
  ...
  onLoad: function(options) {
    ...
    db.collection('min_info').where({
      type: decodeURIComponent(options.type)
    }).get({
      success: res => {
        console.log('min_info'+res.data);
        self.setData({
          postsList: res.data,
        })
    ...
    //       "text": "十五年前的照片，也就是我们认识的时候，并没有留下太多的美好给到我们，依稀记得的，就是叫过你敏敏",
    //     },
    //     {
    //       "id": 2,
    //       "tittle": "我们远离的时候",
    //       "imgurl": "/images/we/look2.jpg",
    //       "text": "起初还有来信，后来，联系越来越少了。我们不知道对方经历着什么，可能人生的轨迹就此岔开，好在长沙的几段联系，把我们拉近",
    //     },
    //     {
    //       "id": 3,
    //       "tittle": "现在的我",
